...
// Generate a padded 7-day array with all days present
...
export default function AgentDetailPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  useEffect(() => {
    ...
    async function load() {
      ...
      // Get live status for this agent
  ...
  const weeklyChart = data ? buildWeeklyChart(data.weeklyStats) : []
    ...
    <div className="p-6 lg:p-8 max-w-6xl mx-auto">
      ...
      <div className="grid grid-cols-2 xl:grid-cols-4 gap-4 mb-6">
        ...
        <StatCard
          ...
          sub={`of ${data?.tasks.length ?? 0} assigned`}
          color="#f59e0b"
        />
      </div>
