...
export const AGENTS: Agent[] = [
  ...
  },
  {
    ...
    slack_channels: ['#aloa-customer-success'],
    spawn_permissions: [],
  ...
  },
  {
    id: 'uppsyke',
    name: 'UpPsyke',
    role: 'Partnership Agent',
    model: 'Claude Sonnet',
    workspace: '~/.openclaw/workspace-uppsyke',
    slack_channels: ['#aloa-psyke'],
    spawn_permissions: [],
    created_at: '2026-03-03T00:00:00Z',
  },
  {
    ...
    model: 'Claude Sonnet',
    workspace: '~/.openclaw/workspace-cro',
    slack_channels: ['#aloa-cro'],
    spawn_permissions: ['sales', 'seo', 'cs'],
  ...
  },
  {
    ...
    slack_channels: ['#aloa-openclaw-community'],
    spawn_permissions: [],
  ...
  },
  {
    ...
    model: 'Claude Sonnet',
    workspace: '~/.openclaw/workspace-ar',
    slack_channels: ['#aloa-hr-ar'],
    spawn_permissions: [],
  ...
  },
  {
    id: 'lsc',
    name: 'Riley',
    role: 'LSC Product Owner',
    model: 'Claude Sonnet',
    workspace: '~/.openclaw/workspace-lsc',
    slack_channels: ['#aloa-lachstocktrading'],
    spawn_permissions: ['dev', 'pm', 'login'],
  ...
  },
  {
    ...
    slack_channels: ['#aloa-aona-product-owner'],
    spawn_permissions: [],
    created_at: '2025-01-01T00:00:00Z',
  },
  {
    ...
    role: 'AIToolRisk PM',
    model: 'Claude Sonnet',
    workspace: '~/.openclaw/workspace-aitoolrisk',
    slack_channels: ['#aloa-aitoolrisk'],
    spawn_permissions: [],
    created_at: '2025-01-01T00:00:00Z',
  },
  {
  ...
  },
  {
    ...
    role: 'Rescue & Cloning',
    model: 'Claude Sonnet',
    workspace: '~/.openclaw/workspace-doc-brown',
    slack_channels: [],
    spawn_permissions: [],
    created_at: '2026-03-11T00:00:00Z',
  },
